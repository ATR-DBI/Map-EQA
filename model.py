...
class Semantic_Mapping(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.task = args.task_config.split("/")[-1].split(".")[0].split("_")[-1]
    ...
    def forward(self, obs, pose_obs, maps_last, poses_last):
        ...
        max_z = int((self.agent_height + 2) / z_resolution - min_h)
        ...
        def get_new_pose_batch(pose, rel_pose_change):
            # 57.29577951308232 means the transformation from radiance to degrees
